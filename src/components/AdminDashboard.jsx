...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    if (!isAdmin()) {
      navigate('/AdminDashboard'); // Replace '/Unauthorized' with the actual path for unauthorized access
    } else {
      navigate('/SomeOtherPage'); // Replace '/SomeOtherPage' with the actual path for admin users
    }
  }, [navigate]);
